...
--
-- Temporary view structure for view `lyhistory`
--

DROP TABLE IF EXISTS `lyhistory`;
/*!50001 DROP VIEW IF EXISTS `lyhistory`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `lyhistory` AS SELECT 
 1 AS `FCDesc`,
 1 AS `year`,
 1 AS `week`,
 1 AS `brand`,
...
--
-- Final view structure for view `lyhistory`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `lyhistory` AS select `tblfclist`.`FCDesc` AS `FCDesc`,`tblhistory`.`year` AS `year`,`tblhistory`.`week` AS `week`,`tblhistory`.`brand` AS `brand`,`tblhistory`.`country` AS `country`,`tblhistory`.`channel` AS `channel`,`tblhistory`.`season` AS `season`,sum(`tblhistory`.`salesUnits`) AS `salesUnits`,if((sum(`tblhistory`.`salesUnits`) <> 0),(sum((`tblhistory`.`air` * `tblhistory`.`salesUnits`)) / sum(`tblhistory`.`salesUnits`)),0) AS `air`,if((sum(`tblhistory`.`salesUnits`) <> 0),(sum(`tblhistory`.`RtlSales`) / sum(`tblhistory`.`salesUnits`)),0) AS `aur`,if((sum(`tblhistory`.`salesUnits`) <> 0),(sum(`tblhistory`.`Cogs`) / sum(`tblhistory`.`salesUnits`)),0) AS `auc`,sum(`tblhistory`.`recUnits`) AS `recUnits`,sum(`tblhistory`.`recCost`) AS `recCost`,sum(`tblhistory`.`recRtl`) AS `recRtl`,sum(`tblhistory`.`sohAdjust`) AS `sohAdjust`,sum(`tblhistory`.`storeInv`) AS `storeInv`,sum(`tblhistory`.`dcInv`) AS `dcInv`,sum(`tblhistory`.`transIn`) AS `transIn`,sum(`tblhistory`.`transOut`) AS `transOut`,sum(`tblhistory`.`RtlSales`) AS `RtlSales`,sum(`tblhistory`.`Cogs`) AS `Cogs` from (`tblfclist` join `tblhistory` on(((`tblfclist`.`LY FC` = `tblhistory`.`fc`) and (`tblfclist`.`Brand` = `tblhistory`.`brand`)))) group by `tblfclist`.`FCDesc`,`tblhistory`.`year`,`tblhistory`.`week`,`tblhistory`.`brand`,`tblhistory`.`country`,`tblhistory`.`channel`,`tblhistory`.`season` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `new_view` AS select `tblfclist`.`FCDesc` AS `FCDesc`,`tblhistory`.`year` AS `year`,`tblhistory`.`week` AS `week`,`tblhistory`.`brand` AS `brand`,`tblhistory`.`country` AS `country`,`tblhistory`.`channel` AS `channel`,`tblhistory`.`season` AS `season`,sum(`tblhistory`.`salesUnits`) AS `SumOfsalesUnits`,if((sum(`tblhistory`.`salesUnits`) <> 0),(sum((`tblhistory`.`air` * `tblhistory`.`salesUnits`)) / sum(`tblhistory`.`salesUnits`)),0) AS `SumofAir`,if((sum(`tblhistory`.`salesUnits`) <> 0),(sum(`tblhistory`.`RtlSales`) / sum(`tblhistory`.`salesUnits`)),0) AS `aur`,if((sum(`tblhistory`.`salesUnits`) <> 0),(sum(`tblhistory`.`Cogs`) / sum(`tblhistory`.`salesUnits`)),0) AS `auc`,sum(`tblhistory`.`recUnits`) AS `SumOfrecUnits`,sum(`tblhistory`.`recCost`) AS `SumOfrecCost`,sum(`tblhistory`.`recRtl`) AS `SumOfrecRtl`,(sum(`tblhistory`.`recRtl`) / sum(`tblhistory`.`recUnits`)) AS `AirRtl`,(sum(`tblhistory`.`recCost`) / sum(`tblhistory`.`recUnits`)) AS `AirCost`,sum(`tblhistory`.`sohAdjust`) AS `SumOfsohAdjust`,sum(`tblhistory`.`storeInv`) AS `SumOfstoreInv`,sum(`tblhistory`.`dcInv`) AS `SumOfdcInv`,sum(`tblhistory`.`transIn`) AS `SumOftransIn`,sum(`tblhistory`.`transOut`) AS `SumOftransOut`,sum(`tblhistory`.`RtlSales`) AS `SumOfRtlSales`,sum(`tblhistory`.`Cogs`) AS `SumOfCogs` from (`tblfclist` join `tblhistory` on(((`tblfclist`.`LY FC` = `tblhistory`.`fc`) and (`tblfclist`.`Brand` = `tblhistory`.`brand`)))) group by `tblfclist`.`FCDesc`,`tblhistory`.`year`,`tblhistory`.`week`,`tblhistory`.`brand`,`tblhistory`.`country`,`tblhistory`.`channel`,`tblhistory`.`season` having (`tblfclist`.`FCDesc` = 'GY C8 18 sep 1') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2018-09-10  9:01:23
