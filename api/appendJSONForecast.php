...
$sql = "DELETE from tblforecast_recovered";
...
$sql = "INSERT INTO tblforecast_recovered(year, plan, brand, country, channel, season, fc, week, salesUnits, air, aur, auc, phUnits,phCost, phRtl,bopUnits,dcInv,sohAdjust, transIn, transOut,datelast, dbnotes,reforecast)
...
{
  //  echo "didn't";
  echo "Error inserting record into tblforecast_recovered:";
